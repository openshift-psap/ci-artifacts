...
class SpecialResourceOperator:
    ...
    def capture_deployment_state():
        run_ansible_playbook("sro_capture_deployment_state")
    ...
    def deploy_from_commit(git_repo, git_ref, image_tag=None):
        ...
        run_ansible_playbook("sro_deploy_custom_commit", opts)
    ...
    def run_e2e_test(git_repo, git_ref):
        ...
        run_ansible_playbook("sro_run_e2e_test", opts)
    ...
    def undeploy_from_commit(git_repo, git_ref):
        ...
        run_ansible_playbook("sro_undeploy_custom_commit", opts)
