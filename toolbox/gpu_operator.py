...
class GPUOperator:
    ...
    def deploy_from_commit(git_repository, git_reference, tag_uid=None):
        ...
        run_ansible_playbook("gpu_operator_deploy_custom_commit", opts)
    ...
    @staticmethod
    def deploy_from_bundle(bundle=None):
        """
        Deploys the GPU Operator from a bundle
        """
        opts = {"gpu_operator_deploy_from": "bundle"}

        if bundle is None or bundle == 'master':
            print("Deploying the GPU Operator from OperatorHub using the master bundle")
            run_ansible_playbook("gpu_operator_deploy_from_operatorhub", opts)

        opts["deploy_bundle_image"] = bundle
        run_ansible_playbook("gpu_operator_deploy_from_operatorhub", opts)

    @staticmethod
    def deploy_from_operatorhub(version=None, channel="stable"):
        """
    ...
    def run_gpu_burn(runtime=None):
        ...
        run_ansible_playbook("gpu_operator_run_gpu-burn", opts)
    ...
    def set_repo_config(repo_file, dest_dir=None):
        ...
        run_ansible_playbook("gpu_operator_set_repo-config", opts)
    ...
    def undeploy_from_commit():
        ...
        run_ansible_playbook("gpu_operator_undeploy_custom_commit")
    ...
    def undeploy_from_operatorhub():
        ...
        run_ansible_playbook("gpu_operator_undeploy_from_operatorhub")
    ...
    def wait_deployment():
        ...
        """
        run_ansible_playbook("gpu_operator_wait_deployment")
    ...
    def capture_deployment_state():
        ...
        """
        run_ansible_playbook("gpu_operator_capture-deployment-state")
    ...
    def cleanup_bundle_from_commit():
        ...
        """
        run_ansible_playbook("gpu_operator_cleanup_bundle_from_commit")
    ...
    def bundle_from_commit(
        ...
        run_ansible_playbook("gpu_operator_bundle_from_commit", opts)
