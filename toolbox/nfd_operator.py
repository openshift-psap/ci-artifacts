...
class NFDOperator:
    ...
    def deploy_from_commit(git_repo, git_ref, image_tag=None):
        ...
        run_ansible_playbook("nfd_operator_deploy_custom_commit", opts)
    ...
    def deploy_from_operatorhub(channel=None):
        ...
        run_ansible_playbook("nfd_operator_deploy_from_operatorhub", opts)
    ...
    def undeploy_from_operatorhub():
        ...
        """
        run_ansible_playbook("nfd_operator_undeploy")
